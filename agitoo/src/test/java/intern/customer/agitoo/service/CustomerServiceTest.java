...
public class CustomerServiceTest {
    ...
    public void CustomerService_CreateCustomer_ReturnsCustomerDto () {
        ...
        CompletableFuture<CustomerDTO> savedCustomerDTO = this.customerService.add (customerDTO);
    ...
    public void CustomerService_AddCustomer_ReturnCustomerNew () {
        ...
        CompletableFuture<CustomerDTO> result = customerService.add (customerDTO);
    ...
    public void CustomerService_UpdateCustomer_ReturnCustomerUpdated () {
        ...
        CompletableFuture<CustomerDTO> updateReturn = customerService.update (customerDTO);
